...
import com.duan.android.base.preference.BasicDataPreferenceUtil;
import com.duan.android.base.utils.GsonUtils;
...
public abstract class SuperBaseModel<T> {
    ...
    protected ConcurrentLinkedQueue<WeakReference<IBaseModelListener>> mWeakListenerArrayList;// 保存监听者们的弱引用
    ...
    public void getCachedDataAndLoad() {
        if (getCachedPreferenceKey() != null) { // 有key 有缓存
